                        ...
                        members: {
                            ...
                            remoteRequest: function(c, f) {
                                ...
                                "war" == c && (p.setData("WAR"), p.setParameter("name", d), p.setParameter("alli", g.get_Id()), p.setParameter("world", q.get_WorldId()), p.addListener("completed", function(b) {
                                    ...
                                    if ("" !== b.getContent() && d !== b.getContent() && !0 !== ClientLib.Data.MainData.GetInstance().get_Player().get_IsSubstituteLogin()) {
                                        ...
                                        null !== f ? (h(f), f.n !== b.getContent() && MeStmain.getInstance().MeStUvWindow(b.getContent(), c)) : MeStmain.getInstance().MeStUvWindow(b.getContent(), c)
                                    } else h("No War")
                                }), p.send());
                            ...
                            MeStUvWindow: function(c, f) {
                                ...
                                var g = new qx.ui.container.Composite((new qx.ui.layout.VBox(4)).set({
                                    ...
                                    n = new qx.ui.container.Composite((new qx.ui.layout.VBox(1)).set({
                                        alignX: "center"
                                    })),
                                ...
                                n.add(q);
                                n.add(k);
                                q.addListener("execute", function(d) {
                                    b.close();
                                ...
                                for (var n = 0; n < d; n++) {
                                    if (null !== b[n] && "undefined" !== b[n]) {
                                        var q = phe.cnc.gui.util.Text.getPoiInfosByType(b[n].t).name,
                                            ...
                                            u = b[n].l,
                                            p = b[n].i,
                                            l = ClientLib.Base.PointOfInterestTypes.GetScoreByLevel(b[n].l),
                                            O = phe.cnc.gui.util.Numbers.formatCoordinates(b[n].x, b[n].y);
                                        x.push([p, q, u, l, b[n].x, b[n].y, O, k])
                                    }
                                    if (n + 1 == d)
                                        for (h("AlliancePois scanned"), g.push("AlliancePois scanned\n"), q = [], q = f.get_Alliance().get_MemberDataAsArray(), g.push("search all Playerbases\n"),
                                            k = 0; k < q.length; k++) W = q[k].Name, ClientLib.Net.CommunicationManager.GetInstance().SendSimpleCommand("GetPublicPlayerInfoByName", {
                                            name: W
                                        }, phe.cnc.Util.createEventDelegate(ClientLib.Net.CommandResult, this, c), !0), k + 1 === q.length && (h("save all Playerbases"), g.push("all Playerbases saved\n"), MeStmain.getInstance().getBasesOnPoi())
                                }
                            },
                            ...
                            FO: function(c) {
                                try {
                                    ...
                                    for (b in d) {
                                        ...
                                        for (var h = "http://cncopt.com/?map=2|" + k + "|" + k + "||" + g + "....................................|newEconomy", p = '<table border="2" cellspacing="0" cellpadding="0" onclick="MeStScanner.Layout.window.getInstance().listener(' +
